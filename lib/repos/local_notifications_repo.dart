...
class LocalNotificationsRepo {
  // Private constructor for singleton pattern
  LocalNotificationsRepo._internal();

  //Singleton instance
  static final LocalNotificationsRepo _instance = LocalNotificationsRepo._internal();

  //Factory constructor to return singleton instance
  factory LocalNotificationsRepo.instance() => _instance;
