...
import 'local_notifications_repo.dart';



class FirebaseNotificationsRepo {
  FirebaseNotificationsRepo._internal();

  // Singleton instance
  static final FirebaseNotificationsRepo _instance = FirebaseNotificationsRepo._internal();

  // Factory constructor to provide singleton instance
  factory FirebaseNotificationsRepo.instance() => _instance;

  // Reference to local notifications service for displaying notifications
  LocalNotificationsRepo? _localNotificationsService;

  /// Initialize Firebase Messaging and sets up all message listeners
  Future<void> init({required LocalNotificationsRepo localNotificationsService}) async {
